            ...
            <div className='container-app'>
                    ...
                    <div>
                        ...
                        <p className='text-lg text-white mb-8'>
                            Uma plataforma simples e eficiente para controlar suas despesas e receitas. Organize
                             suas finaças pessoais ou do seu negócio com facilidade.
                        </p>
                ...
                <section className='py-12 md:py-20 bg-gray-900 rounded-xl'>
                    <div className='container-app'>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mr-8 ml-8'>
                ...
                <section className='py-12 md:py-20'>
                    <div className='bg-gray-900 p-8 md:p-12 rounded-xl text-center border border-gray-700 '>
                        ...
                        <p className='text-white text-opacity-90 max-w-2xl mx-auto mb-4'>
                            Começe a usar o DevBills hoje mesmo e tenha controle sobre seu dinheiro. É
