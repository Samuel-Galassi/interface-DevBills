    ...
    const transactionsTypeButtons = [
        {
            ...
            inativeClasses:"bg-trasparent border-red-300 text-red-700 hover:bg-red-50"
        },
        {
            type: TransactionType.INCOME,
            label: "Receita",
            activeClasses:"bg-green-100 border-green-500 text-green-700 font-medium",
            inativeClasses:"bg-trasparent border-green-300 text-green-500 hover:bg-green-50"
        },
    ]
